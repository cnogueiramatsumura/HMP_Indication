...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8bf6e4a9f4f4accf13e9";
...
/******/ 	return hotCreateRequire("./Scripts/Areas/Usuario/ComprarBNB/ComprarBNB.js")(__webpack_require__.s = "./Scripts/Areas/Usuario/ComprarBNB/ComprarBNB.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./Scripts/Areas/ComunFunctions.js":
/*!*****************************************!*\
  !*** ./Scripts/Areas/ComunFunctions.js ***!
  \*****************************************/
/*! exports provided: fadeOut, fadeIn, counttime, formatHourMenu, showTime, AtualizarStatusTabela, PercentualGain, PercentualLoss, WebppAppRedirect */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "counttime", function() { return counttime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatHourMenu", function() { return formatHourMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showTime", function() { return showTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AtualizarStatusTabela", function() { return AtualizarStatusTabela; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PercentualGain", function() { return PercentualGain; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PercentualLoss", function() { return PercentualLoss; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WebppAppRedirect", function() { return WebppAppRedirect; });
...
function AtualizarStatusTabela(ordemId, Status_Id, Msg) {
...
/***/ "./Scripts/Areas/Usuario/ComprarBNB/ComprarBNB.js":
/*!********************************************************!*\
  !*** ./Scripts/Areas/Usuario/ComprarBNB/ComprarBNB.js ***!
  \********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _Filter_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Filter.js */ "./Scripts/Areas/Usuario/ComprarBNB/Filter.js");
/* harmony import */ var _DashBoard_MarketValue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../DashBoard/MarketValue */ "./Scripts/Areas/Usuario/DashBoard/MarketValue.js");
﻿



$(function () {
    _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setFilterValue();
    _DashBoard_MarketValue__WEBPACK_IMPORTED_MODULE_1__["MarketValue"].init();
    _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setBNBMarketValue();

    $("#input-btc").on("keyup", function () {
        var amoutbtc = this.value;
        var precoBNB = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getBNBvalue();
        var qtd = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setAmoutField(amoutbtc / precoBNB);
        $("#input-amount").val(qtd);
        var bitcoinvalue = _DashBoard_MarketValue__WEBPACK_IMPORTED_MODULE_1__["MarketValue"].getBTCtoBRLValue();
    ...
    $("#input-btc").on("change", function () {
        ...
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].ValidateBTCField(btcValue);

        var precoBNB = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getBNBvalue();
        var qtd = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setAmoutField(btcValue / precoBNB);
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].ValidateAmountField(qtd);  
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].isValid();
    });
    ...
    $("#input-brl").on("keyup", function () {
        ...
        var precoBNB = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getBNBvalue();
        var qtd = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setAmoutField(totalbtc / precoBNB);
        if (precoBNB * qtd < _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getMinNotionalValue()) {
            var LotSize = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getLotSizeValue();
            qtd = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setAmoutField(qtd + LotSize);
        }
    ...
    $("#input-brl").on("change", function () {
        ...
        var bitcoinvalue = _DashBoard_MarketValue__WEBPACK_IMPORTED_MODULE_1__["MarketValue"].getBTCtoBRLValue();
        var totalbtc = (value / bitcoinvalue).toFixed(8);
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].ValidateBTCField(totalbtc);
        var precoBNB = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].getBNBvalue();
        var qtd = _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].setAmoutField(totalbtc / precoBNB);
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].ValidateAmountField(qtd);
        _Filter_js__WEBPACK_IMPORTED_MODULE_0__["Filter"].isValid();
...
/***/ "./Scripts/Areas/Usuario/ComprarBNB/Filter.js":
/*!****************************************************!*\
  !*** ./Scripts/Areas/Usuario/ComprarBNB/Filter.js ***!
  \****************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Filter", function() { return Filter; });
﻿
...
/***/ "./Scripts/Areas/Usuario/DashBoard/MarketValue.js":
/*!********************************************************!*\
  !*** ./Scripts/Areas/Usuario/DashBoard/MarketValue.js ***!
  \********************************************************/
/*! exports provided: MarketValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MarketValue", function() { return MarketValue; });
/* harmony import */ var _ComunFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../ComunFunctions.js */ "./Scripts/Areas/ComunFunctions.js");
﻿
    ...
    return {
        ...
        setBTCValue: function () {
            $.ajax({
                ...
                error: function (data) {
                    Object(_ComunFunctions_js__WEBPACK_IMPORTED_MODULE_0__["WebppAppRedirect"])(data);
                }
            })
        },
...
/******/ });
//# sourceMappingURL=CompraBNB.js.map?f2d3a14c26a026885f368d2a2fadd742